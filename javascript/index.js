         ...
         getInstruction("mashedPotatoes", 3, (step3) => {
           ...
           getInstruction("mashedPotatoes", 4, (step4) => {
            document.querySelector("#mashedPotatoes").innerHTML += `<li>${step4}</li>`;
              ...
              document.querySelector("mashedPotatoesImage").removeAttribute("hidden");
            });
           });
         });
      });
     ...
     document.querySelector("#steak").innerHTML += `<li>${step4}</>`;
       ...
       document.querySelector("#steak").innerHTML += `<li>${step5}</>`;
        ...
        obtainInstruction("steak", 7).then((step7) => {
            ...
            document.querySelector("steakImage").removeAttribute("hidden");
            });
         });
       });
      });
...
async function makeBroccoli() {
  ...
  document.querySelector("#broccoliImage").removeAttribute("hidden");
}
makeBroccoli();
